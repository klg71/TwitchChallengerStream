...
defmodule RiotApi.Spectator do
  ...
  @moduledoc """
  Documentation for RiotApi.Spectator
  """

  @doc """
  Contains methods for starting and terminating league spectator client
  """
